  ...
  <div>
    ...
    <section class="px-16 text-center overflow-hidden mt-52">
      ...
      <div class="overflow-hidden">
        ...
        <h2 ref="contactHeading" class="whitespace-nowrap py-36">"LET’S TALK — LET’S COLLABORATE — SAY HELLO — WANNA BE STARTING SOMETHING?""</h2>
        <!-- Right ro Left bar -->
        <div class="relative w-full h-px bg-transparent">
